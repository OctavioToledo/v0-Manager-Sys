...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/service/public/**").permitAll()
                        .requestMatchers("/api/v1/employee/public/**").permitAll()
                        .requestMatchers("/api/v1/business/*/hours/public").permitAll()
                        .requestMatchers("/api/v1/employees/*/hours/public").permitAll()
                        .requestMatchers("/api/v1/appointment/public/**").permitAll()
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> {
            ...
            // No more ignoring() for API endpoints to ensure CORS works correctly
        };
    }
}
